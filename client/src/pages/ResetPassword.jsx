...
const ResetPassword = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {/* enter email id */}
      {!isEmailSent && <form onSubmit={onEmailSubmit} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C] text-indigo-300'>
          ...
          <input type="email" placeholder='Email Id' className='bg-transparent outline-none w-full' value={email} onChange={e => setEmail(e.target.value)} required />
        </div>
      ...
      {isOtpSubmited && isEmailSent && <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C] text-indigo-300'>
          ...
          <input type="password" placeholder='New Password' className='bg-transparent outline-none w-full' value={newPassword} onChange={e => setNewPassword(e.target.value)} required />
        </div>
